...
RSpec.describe "match_ts_schema" do
  ...
  it "names an undeclared key" do
    expect {
      expect(valid.merge("created_at" => "2026-09-11")).to match_ts_schema(source, "Role")
